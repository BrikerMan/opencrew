...
${C_BOLD}${C_BLUE}━━━ Roles ━━━${C_RESET}

  ${C_BOLD}Primary${C_RESET}     ${C_CYAN}lead${C_RESET} ${C_DIM}(default)${C_RESET}  ${C_CYAN}coder${C_RESET}  ${C_CYAN}qa${C_RESET}
  ${C_BOLD}Sub${C_RESET}         ${C_MAGENTA}researcher${C_RESET}  ${C_MAGENTA}fixer${C_RESET}  ${C_MAGENTA}butler${C_RESET}
  ${C_BOLD}Built-in${C_RESET}    explore  general ${C_DIM}(document lookup may vary by OpenCode version)${C_RESET}

${C_BOLD}${C_BLUE}━━━ Skills (13) ━━━${C_RESET}

  ${C_BOLD}Methodology${C_RESET}    bm.brainstorming  bm.verification  bm.systematic-troubleshooting
  ${C_BOLD}Product/Tools${C_RESET}  bm.voice-of-user  bm.research  bm.review-checklist  bm.skill-improvement
  ${C_BOLD}Management${C_RESET}     bm.project-mgmt  bm.meeting
  ${C_BOLD}Life${C_RESET}           bm.health  bm.life-journal  bm.wellness  bm.communication

${C_BOLD}${C_BLUE}━━━ File layout ━━━${C_RESET}

  ${C_DIM}All artifacts land in the directory where you launch opencode.${C_RESET}

  ${C_GREEN}./scripts/${C_RESET}    scripts
  ${C_GREEN}./working/${C_RESET}    intermediate artifacts (visible, not hidden)
  ${C_GREEN}./output/${C_RESET}     final artifacts ${C_DIM}(or write to root, follow your habits)${C_RESET}
